...
layout: post
---
Today I worked mostly on the last two 'beast' exercises from [watch and code premium.](https://watchandcode.com/) I spent a lot of time in the debugger with this one, but I finally got it. I essentially split the number given to the function into a 'left' and 'right' side of the decmial.
